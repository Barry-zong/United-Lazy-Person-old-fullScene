    ...
    public class MetaXRControlMethod : CurvedUIControlMethod
    {
        ...
        public override void Initialize(bool isPlayMode)
        {
            ...
            if (cameraRig == null)
            {
                ...
                if (cameraRig == null)  cameraRig = UnityEngine.Object.FindFirstObjectByType<OVRCameraRig>();
            ...
            {
                if (UnityEngine.Object.FindFirstObjectByType<Oculus.Interaction.Input.HandSkeletonOVR>() is var skeleton 
                    && skeleton != null 
